...
class LoraConfig(PeftConfig):
    ...
    #! added
    # lora_expert_A: int = field(default=1, metadata={"help": "Expert num for Lora A"})
    # lora_expert_B: int = field(default=1, metadata={"help": "Expert num for Lora B"})
    ...
    #! added
    # expert_A_pattern: Optional[dict] = field(
    #     default_factory=dict,
    #     metadata={
    #         "help": (
    #             "TBD"
    ...
    #     },
    # )
    # expert_B_pattern: Optional[dict] = field(
    #     default_factory=dict,
    #     metadata={
    #         "help": (
    #             "TBD"
    ...
    #     },
    # )
    lora_use_mixer_pattern: Optional[dict] = field(
        default_factory=dict,
        metadata={
            "help": (
                "TBD"
